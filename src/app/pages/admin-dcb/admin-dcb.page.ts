...
@Component({
  selector: 'app-admin-dcb',
  templateUrl: './admin-dcb.page.html',
  styleUrls: ['./admin-dcb.page.scss'],
})
export class AdminDCBPage implements OnInit {
  commands: CommandInt[];
  totalCmds: number;
  ...
  fetchCmds(id): void {
    this.servHttp.adminDCB(id).subscribe(
      (data: CommandInt[]) => {
